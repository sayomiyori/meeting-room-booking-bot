...
| In-memory rate limit + FSM | Корректно для однопроцессного деплоя (текущий, 1 worker). При масштабировании на несколько воркеров/инстансов потребуется вынести в Redis |
